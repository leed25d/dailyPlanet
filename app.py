...
########################################################################
##  POST /groups
##      Creates a empty group. POSTs to an existing group should be
##      treated as errors and flagged with the appropriate HTTP status
##      code. The body should contain a `name` parameter ----
...
##      Updates the membership list for the group. The body of the
